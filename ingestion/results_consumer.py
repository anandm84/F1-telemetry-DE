...
KAFKA_TOPIC = os.getenv("KAFKA_TOPIC", "f1_race_results")
KAFKA_GROUP_ID = os.getenv("KAFKA_GROUP_ID", "f1-results-consumer-v1")
KAFKA_AUTO_OFFSET_RESET = os.getenv("KAFKA_AUTO_OFFSET_RESET", "earliest")
BRONZE_DIR = os.getenv("BRONZE_DIR", "data/bronze/race_results")
BRONZE_FILE_PREFIX = os.getenv("BRONZE_FILE_PREFIX", "results.ndjson")
        ...
        if idle_for_seconds >= BRONZE_MAX_IDLE_SECONDS:
            ...
            if BRONZE_EXIT_ON_IDLE:
                print(
                    ...
                    "Flushed buffers and exiting results consumer."
                )
                break
